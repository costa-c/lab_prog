...
public class AdditionQuizNoGlobals {
    ...
    public static void main(String[] args) throws Exception {
        int[] firstNums = new int[10]; // The first numbers in all ten questions.
        int[] secondNums = new int[10]; // The second numbers in all ten questions.
        int[] answers = new int[10]; // The user's answers to the ten questions.
        System.out.println();
